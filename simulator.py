...
if __name__ == '__main__':
    ...
    while event_list:
        ...
        #upload_done event/expire asli
        #if next_event.action.__name__ == 'upload_done':  
        ...
        if (counter%TIMELINE_LENGTH)==TIMELINE_LENGTH-1:
                ...
                #filename7='upload_done_events-1t-'+ str(counter+1)
                #file_list7.append(filename7)
                #with open(filename7, 'wb') as f7:             
                #    pickle.dump(time_list_c7,f7)
                #time_list_c7 = []

                #upload done event original
                #filename8='cache_content_cdn_events-1t-'+ str(counter+1)
    ...
    #if next_event.action.__name__ == 'upload_done':
    #    filename7='upload_done_events-1t-'+ str(counter)
    #    file_list7.append(filename7)
    #    time_list_c7.append(( next_event.time, str(next_event.actor) , next_event.type, next_event.action_params[0]))
    #    with open(filename7, 'wb') as f7:
    #         pickle.dump(time_list_c7, f7) 
